    ...
    def __init__(
        ...
        self.route_dict = {
            "media": [
                ...
                "was läuft gerade",
                "Spiel this is taylor swift auf Spotify",
                "Spiel fate of ophelia von taylor swift auf spotify",
                "spiel meine lieblingssongs auf spotify",
            ...
            "information": [
                ...
                "uhrzeit in Tokio",
                "welche zeit haben wir in New York",
                "wie viel uhr ist es in Bremen",
                "zeit in deutschland",
                "wie ist die uhrzeit",
                "sag mir die zeit für London",
                "wie ist das wetter",
                "brauche ich heute einen regenschirm",
                "wie warm ist es draußen",
                "wetterbericht für bremen",
                "wie ist das wetter in berlin",
                "regnet es gerade",
                "wird es heute noch sonnig",
                "temperatur in münchen",
                "sag mir das wetter für morgenwie ist das wetter",
                "brauche ich heute einen regenschirm",
                "wie warm ist es draußen",
                "wetterbericht für bremen",
                "wie ist das wetter in berlin",
